...
File a GitHub [issue](https://github.com/cloudposse/fluentd-datadog/issues), send us an [email](mailto:hello@cloudposse.com) or reach out to us on [Gitter](https://gitter.im/cloudposse/).
## Contributing

### Bug Reports & Feature Requests

Please use the [issue tracker](https://github.com/cloudposse/fluentd-datadog/issues) to report any bugs or file feature requests.

### Developing

If you are interested in being a contributor and want to get involved in developing `fluentd-datadog`, we would love to hear from you! Shoot us an [email](mailto:hello@cloudposse.com).
